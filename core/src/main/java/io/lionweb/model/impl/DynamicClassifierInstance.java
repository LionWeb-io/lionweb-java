...
/** Abstract base for dynamically-typed classifier instances that store feature values in maps rather than statically-typed fields. */
public abstract class DynamicClassifierInstance<T extends Classifier<T>>
  ...
  public List<Node> getChildren(@Nonnull Containment containment) {
    ...
    ensureHaveContainment(containment);
