 ...
 * is defined as UsedLanguage in the specifications (see
 * https://github.com/LionWeb-io/specification/issues/129). In this implementation, the pair has a
 * more general name as UsedLanguage is just one role or use we can attribute to the pair language
 * key and version.
 */
