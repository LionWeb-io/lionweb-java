...
public class DebugUtils {
    ...
    /**
     * This variant of qualified name can be obtained also for invalid states. This is intended to be used
     * in methods which should not throw exceptions, like toString methods.
     */
