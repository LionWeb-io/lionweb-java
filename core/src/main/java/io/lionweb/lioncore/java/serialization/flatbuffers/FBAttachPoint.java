...
public final class FBAttachPoint extends Table {
  ...
  public io.lionweb.lioncore.java.serialization.flatbuffers.FBMetaPointer containment() {
    return containment(new io.lionweb.lioncore.java.serialization.flatbuffers.FBMetaPointer());
  }
