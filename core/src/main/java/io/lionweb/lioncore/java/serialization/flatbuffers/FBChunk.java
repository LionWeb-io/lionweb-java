...
public final class FBChunk extends Table {
  ...
  public io.lionweb.lioncore.java.serialization.flatbuffers.FBLanguage languages(int j) {
    return languages(new io.lionweb.lioncore.java.serialization.flatbuffers.FBLanguage(), j);
  }

  public io.lionweb.lioncore.java.serialization.flatbuffers.FBLanguage languages(
      io.lionweb.lioncore.java.serialization.flatbuffers.FBLanguage obj, int j) {
    int o = __offset(6);
  ...
  public io.lionweb.lioncore.java.serialization.flatbuffers.FBLanguage.Vector languagesVector() {
    return languagesVector(
        new io.lionweb.lioncore.java.serialization.flatbuffers.FBLanguage.Vector());
  }

  public io.lionweb.lioncore.java.serialization.flatbuffers.FBLanguage.Vector languagesVector(
      io.lionweb.lioncore.java.serialization.flatbuffers.FBLanguage.Vector obj) {
    int o = __offset(6);
