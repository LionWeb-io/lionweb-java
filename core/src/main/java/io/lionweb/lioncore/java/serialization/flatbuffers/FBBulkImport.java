...
public final class FBBulkImport extends Table {
  ...
  public io.lionweb.lioncore.java.serialization.flatbuffers.FBAttachPoint attachPoints(int j) {
    return attachPoints(new io.lionweb.lioncore.java.serialization.flatbuffers.FBAttachPoint(), j);
  }

  public io.lionweb.lioncore.java.serialization.flatbuffers.FBAttachPoint attachPoints(
      io.lionweb.lioncore.java.serialization.flatbuffers.FBAttachPoint obj, int j) {
    int o = __offset(4);
  ...
  public io.lionweb.lioncore.java.serialization.flatbuffers.FBAttachPoint.Vector
      attachPointsVector() {
    return attachPointsVector(
        new io.lionweb.lioncore.java.serialization.flatbuffers.FBAttachPoint.Vector());
  }

  public io.lionweb.lioncore.java.serialization.flatbuffers.FBAttachPoint.Vector attachPointsVector(
      io.lionweb.lioncore.java.serialization.flatbuffers.FBAttachPoint.Vector obj) {
    int o = __offset(4);
    return o != 0 ? obj.__assign(__vector(o), 4, bb) : null;
  }

  public io.lionweb.lioncore.java.serialization.flatbuffers.FBNode nodes(int j) {
    return nodes(new io.lionweb.lioncore.java.serialization.flatbuffers.FBNode(), j);
  }

  public io.lionweb.lioncore.java.serialization.flatbuffers.FBNode nodes(
      io.lionweb.lioncore.java.serialization.flatbuffers.FBNode obj, int j) {
    int o = __offset(6);
    return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null;
  }
  ...
  public io.lionweb.lioncore.java.serialization.flatbuffers.FBNode.Vector nodesVector() {
    return nodesVector(new io.lionweb.lioncore.java.serialization.flatbuffers.FBNode.Vector());
  }

  public io.lionweb.lioncore.java.serialization.flatbuffers.FBNode.Vector nodesVector(
      io.lionweb.lioncore.java.serialization.flatbuffers.FBNode.Vector obj) {
    int o = __offset(6);
    return o != 0 ? obj.__assign(__vector(o), 4, bb) : null;
  }
