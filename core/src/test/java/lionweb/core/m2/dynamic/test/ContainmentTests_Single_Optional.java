...
public class ContainmentTests_Single_Optional extends DynamicNodeTestsBase
{
//    #region Single
...
//        Assert.assertSame(parent, doc.getParent());
//        Assert.assertSame(doc, parent.getChildren(Geometry_documentation()));
//    }

//    @Test
//    public void Existing_Reflective()
//    {
//        Node oldDoc = newDocumentation("old");
//        AbstractClassifierInstance parent = newGeometry("g");
//        parent.addChild(Geometry_documentation(), oldDoc);
//        Node doc = newDocumentation("myId");
//        parent.addChild(Geometry_documentation(), doc);
//        Assert.assertNull(oldDoc.getParent());
//        Assert.assertSame(parent, doc.getParent());
//        Assert.assertSame(doc, parent.getChildren(Geometry_documentation()));
//    }
...
//    #region Null
    ...
    public void Null_Reflective()
    {
        ...
        Assert.assertNull(parent.getChildren(Geometry_documentation()));
    }
...
//            parent.addChild(Geometry_documentation(), values));
//    }
//
//    @Test
...
//    {
//        AbstractClassifierInstance parent = newGeometry("g");
//        AbstractClassifierInstance value = newDocumentation("s");
...
//    {
//        AbstractClassifierInstance parent = newGeometry("g");
//        AbstractClassifierInstance valueA = newDocumentation("sA");
//        AbstractClassifierInstance valueB = newDocumentation("sB");
