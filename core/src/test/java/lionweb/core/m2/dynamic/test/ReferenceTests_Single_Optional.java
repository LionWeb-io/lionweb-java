...
public class ReferenceTests_Single_Optional extends DynamicNodeTestsBase
{
////    #region Single
//
//    @Test
...
//        parent.addReferenceValue(OffsetDuplicate_altSource(), reference);
//        Assert.assertNull(reference.getParent());
//        Assert.assertSame(reference, parent.getReferenceValues(OffsetDuplicate_altSource()));
//    }
//
//    @Test
...
//        AbstractClassifierInstance parent = newOffsetDuplicate("g");
//        parent.addReferenceValue(OffsetDuplicate_altSource(), oldReference);
//        AbstractClassifierInstance reference = newLine("myId");
//        parent.addReferenceValue(OffsetDuplicate_altSource(), reference);
...
//        Assert.assertNull(parent.getReferenceValues(OffsetDuplicate_altSource()));
//    }
//
////    #endregion
//
...
//            parent.addReferenceValue(OffsetDuplicate_altSource(), values));
//    }
//
//    @Test
