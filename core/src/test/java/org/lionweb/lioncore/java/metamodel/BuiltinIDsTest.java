...
public class BuiltinIDsTest {
    ...
    public void M3ElementsHasExpectedIDs() {
        ...
        assertEquals("LIonCore_M3_Concept_abstract", LionCore.getConcept().getPropertyByName("abstract").getID());
        assertEquals("LIonCore_M3_Concept_extends", LionCore.getConcept().getReferenceByName("extends").getID());
        assertEquals("LIonCore_M3_Concept_implements", LionCore.getConcept().getReferenceByName("implements").getID());

        assertEquals("LIonCore_M3_ConceptInterface", LionCore.getConceptInterface().getID());
        assertEquals("LIonCore_M3_ConceptInterface_extends", LionCore.getConceptInterface().getReferenceByName("extends").getID());
        ...
        assertEquals("LIonCore_M3_Enumeration_literals", LionCore.getEnumeration().getContainmentByName("literals").getID());
        ...
        assertEquals("LIonCore_M3_Feature_optional", LionCore.getFeature().getPropertyByName("optional").getID());

        assertEquals("LIonCore_M3_FeaturesContainer", LionCore.getFeaturesContainer().getID());
        assertEquals("LIonCore_M3_FeaturesContainer_features", LionCore.getFeaturesContainer().getContainmentByName("features").getID());

        assertEquals("LIonCore_M3_Link", LionCore.getLink().getID());
        assertEquals("LIonCore_M3_Link_multiple", LionCore.getLink().getPropertyByName("multiple").getID());
        ...
        assertEquals("LIonCore_M3_Property_type", LionCore.getProperty().getReferenceByName("type").getID());
