...
public class TreeGenerator {
    ...
    private Node generateNode() {
        Concept concept = SimpleLanguage.subConcepts.get(random.nextInt(SimpleLanguage.subConcepts.size()));
        ...
        ClassifierInstanceUtils.setPropertyValueByName(node, "intProp", Integer.toString(skewRandomInt()));
        return node;
    }
