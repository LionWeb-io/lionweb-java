                ...
                if (eStructuralFeature instanceof EAttribute) {
                    ...
                    if (eAttribute.getEAttributeType().equals(EcorePackage.eINSTANCE.getEInt())) {
                        if (eStructuralFeature.isMany()) {
                            ...
                            eObject.eSet(eStructuralFeature, Integer.parseInt(jsonFeatureValue.getAsString()));
                        }
                    ...
                    if (eReference.isContainment()) {
                        if (eStructuralFeature.isMany()) {
                            ...
                            jsonFeatureValue.getAsJsonArray().forEach(e -> children.add(readEObject(e.getAsJsonObject(), resource, ((EReference) eStructuralFeature).getEReferenceType())));
                            eObject.eSet(eStructuralFeature, children);
                        } else {
                            EObject child = readEObject(jsonFeatureValue.getAsJsonObject(), resource, ((EReference) eStructuralFeature).getEReferenceType());
