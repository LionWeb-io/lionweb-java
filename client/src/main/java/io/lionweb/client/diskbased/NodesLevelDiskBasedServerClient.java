...
public class NodesLevelDiskBasedServerClient
    implements BulkAPIClient, DBAdminAPIClient, InspectionAPIClient {
  private final @NotNull ChunkLevelDiskBasedServerClient chunkLevel;
  private @Nullable AbstractSerialization serialization;

  public NodesLevelDiskBasedServerClient(@NotNull DiskBasedServer diskBasedServer) {
    this.chunkLevel = new ChunkLevelDiskBasedServerClient(diskBasedServer);
  }
   ...
   */
  public NodesLevelDiskBasedServerClient(
      @NotNull DiskBasedServer diskBasedServer, @NotNull String repositoryName) {
    Objects.requireNonNull(repositoryName);
    this.chunkLevel = new ChunkLevelDiskBasedServerClient(diskBasedServer, repositoryName);
  }
