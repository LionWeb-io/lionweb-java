...
/**
 * HTTP client implementation of {@link io.lionweb.client.api.JSONLevelBulkAPIClient} that exchanges
 * raw JSON payloads without deserializing them into model objects.
 */
