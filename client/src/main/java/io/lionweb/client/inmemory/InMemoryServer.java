...
public class InMemoryServer {
  ...
  //
    ...
    /**
     * Monitors the specified {@link DeltaChannel} to handle command and query operations for a given repository.
     *
     * This method sets up the provided DeltaChannel by registering command and query receivers
     * that are tailored to the context of the specified repository. The command receiver is responsible
     * for processing client-initiated commands, while the query receiver handles queries requesting
