...
@Testcontainers
public class LionWebClientDBAdminApiFunctionalTest extends AbstractClientInMemoryFunctionalTest {

  public LionWebClientDBAdminApiFunctionalTest() {
    super(LionWebVersion.v2024_1);
  }

  @Test
  public void repositoriesCRUD() {
    ...
    RepositoryConfiguration repo2 =
        new RepositoryConfiguration("repo2", LionWebVersion.v2023_1, HistorySupport.DISABLED);
