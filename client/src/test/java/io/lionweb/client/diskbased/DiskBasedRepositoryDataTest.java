...
public class DiskBasedRepositoryDataTest {
  ...
  public void addSingleNode() {
    ...
    assertEquals(new HashSet<>(Collections.singletonList("n1")), repositoryData.getNodesIDs());
  }
...
//        new DiskBasedRepositoryData(
//            new RepositoryConfiguration("repo1", LionWebVersion.v2023_1, HistorySupport.DISABLED));
//      repoData.setMaxHotPartitions(0);
...
//    DiskBasedRepositoryData res = new DiskBasedRepositoryData(
//        new RepositoryConfiguration("repo1", LionWebVersion.v2023_1, HistorySupport.DISABLED));
//      res.setMaxHotPartitions(0);
//    return res;
//  }
//
//  @Test
