...
public class PropertiesLanguage {
    ...
    static {
        ...
        propertiesLanguage = new Language(
                name,
                "language-" + cleanedName + "-id",
                "language-" + cleanedName + "-key",
                "1"
        );
    ...
    private static Containment addContainment(Classifier<?> owner, String name, Classifier<?> target, Multiplicity multiplicity) {
