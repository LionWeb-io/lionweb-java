...
public class RepositoryConfiguration {
    ...
    public RepositoryConfiguration(@NotNull String name, @NotNull LionWebVersion lionWebVersion, @NotNull HistorySupport historySupport) {
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(historySupport, that.historySupport) && Objects.equals(name, that.name) && lionWebVersion == that.lionWebVersion;
    }
