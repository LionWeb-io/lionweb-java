...
public class LionWebRepoClient {
    ...
    public LionWebRepoClient() {
        this("localhost", 3005, "default", null,
                "GenericJavaBasedLionWebClient");
    }

    public LionWebRepoClient(@NotNull String hostname, int port, @NotNull String repository,
                             @Nullable String authorizationToken, @NotNull String clientID) {
        ...
        this.lowLevelRepoClient = new LowLevelRepoClient(
                hostname, port, authorizationToken, clientID, repository,
                connectTimeoutInSeconds, callTimeoutInSeconds, debug);
    ...
    public JsonSerialization calculateJsonSerialization() {
        JsonSerialization serialization = (jsonSerializationProvider != null)
        ...
        try {
            ...
            return processChunkResponse(data, new ChunkProcessor<List<String>>() {
                public List<String> process(JsonElement jsonElement) {
                    ...
                    SerializationChunk chunk = serialization.deserializeSerializationBlock(jsonElement);
