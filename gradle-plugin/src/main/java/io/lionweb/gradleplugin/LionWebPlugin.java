      ...
      project
          ...
          .withPlugin(
              ...
              appliedPlugin -> {
                ...
                project
                    .getDependencies()
                    .add("implementation", "io.lionweb:lionweb-2024.1-core:" + BuildConfig.VERSION);
                project.getDependencies().add("implementation", "org.jetbrains:annotations:17.0.0");
              });

      // If user uses java-library instead of java, this still works because java-library applies
      // java,
    ...
    project
        ...
        .register(
            ...
            task -> {
              ...
              if (ext.getLanguagesToGenerate().isPresent()) {
