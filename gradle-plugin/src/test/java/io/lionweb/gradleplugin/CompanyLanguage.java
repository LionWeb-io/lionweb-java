...
public class CompanyLanguage extends Language {
  ...
  private CompanyLanguage() {
    ...
    setVersion("v1.0");
    Concept company = new Concept(LionWebVersion.v2023_1, "Company");
    company.setPartition(true);
    Concept department = new Concept(LionWebVersion.v2023_1, "Department");
    Concept employee = new Concept(LionWebVersion.v2023_1, "Employee");
    Concept role = new Concept(LionWebVersion.v2023_1, "Role");
    ...
    employee.addProperty(
        "first name", LionCoreBuiltins.getString(LionWebVersion.v2023_1), Multiplicity.REQUIRED);
    employee.addProperty(
        "last name", LionCoreBuiltins.getString(LionWebVersion.v2023_1), Multiplicity.REQUIRED);
    employee.addProperty(
        "salary", LionCoreBuiltins.getInteger(LionWebVersion.v2023_1), Multiplicity.REQUIRED);
    ...
    role.addProperty(
        "min salary", LionCoreBuiltins.getInteger(LionWebVersion.v2023_1), Multiplicity.OPTIONAL);
    role.addProperty(
        "max salary", LionCoreBuiltins.getInteger(LionWebVersion.v2023_1), Multiplicity.OPTIONAL);
